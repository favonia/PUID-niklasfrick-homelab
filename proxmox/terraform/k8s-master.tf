...
# VM Name: k8s-master.local.zazen.li
# Description: Trusted Server VLAN Kubernetes Cluster Master Node
...
#     target_node = "pve"
#     vmid = "102"
#     name = "k8s-master.local.zazen.li"
#     desc = "Trusted Server VLAN Kubernetes Cluster Master Node"
#     pool = "pbs-backup"
#     tags = "pbs-backup"
#     qemu_os = "l26"
