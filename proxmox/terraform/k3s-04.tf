...
# VM Name: k3s-04.home.balzers.xyz
# Description: Trusted Server VLAN k3s Server 4
# IP Address: 10.96.10.23/24
...
resource "proxmox_vm_qemu" "k3s_04" {
    ...
    ipconfig0 = "ip=10.96.10.23/24,gw=10.96.10.1"
...
resource "unifi_user" "k3s_04_trusted" {
